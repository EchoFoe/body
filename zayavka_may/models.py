...
class Zayavka_may(models.Model):
    ...
    weight = models.DecimalField(max_digits=6, decimal_places=2, default=True, verbose_name='Фактический вес спортсмена')
    raised_weight = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True, default=00.00, verbose_name='Поднятый вес спортсменом')
