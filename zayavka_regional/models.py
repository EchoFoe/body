...
class Zayavka_regional(models.Model):
    ...
    message = models.TextField(max_length=128, null=True, default=True, verbose_name='Сообщение')
    ...
    def __str__(self):
        return "Региональный представитель: %s %s, почта: %s" % (self.first_name, self.last_name, self.email)
