...
class Sportsman(models.Model):
    ...
    weight_category = models.ForeignKey(Weight_category, null=True, on_delete=models.CASCADE,
                                        verbose_name='Вес. категория')
...
class SportsmanImage(models.Model):
    Sportsman = models.ForeignKey(Sportsman, null=True, default=None, on_delete=models.CASCADE, verbose_name='Спортсмен')
    image = models.ImageField(upload_to='sportsman_images/', verbose_name='Фотография спортсмена')
